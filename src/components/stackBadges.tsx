        ...
        if (IconComponent) {
          return (
            ...
            >
              ...
              <div
                className="absolute -bottom-8 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                <div
                  className="whitespace-nowrap rounded bg-amber-950/95 px-2 py-1 text-xs text-amber-200 border border-amber-800/60 backdrop-blur-sm">
                  {displayName}
                </div>
              </div>
            </div>
